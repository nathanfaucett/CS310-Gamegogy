...
| Test Click Leaderboard Lowest    | Start Application                 | edu.jsu.mcis.gamegogy.GamegogyGUI |                     |
...
| Test Click Leaderboard Highest   | Start Application                 | edu.jsu.mcis.gamegogy.GamegogyGUI |                     |
|                                  | Select Window                     | Gamegogy                         |                     |
...
|                                  | Close Window                      | Gamegogy                         |                     |
| Test Click Leaderboard Middle    | Start Application                 | edu.jsu.mcis.gamegogy.GamegogyGUI |                     |
|                                  | Select Window                     | Gamegogy                         |                     |
